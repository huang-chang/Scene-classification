...
tf.app.flags.DEFINE_string(
    'train_dir', '/data/huang/behaviour/data/tfmodel',
...
tf.app.flags.DEFINE_string(
    'dataset_dir', '/data/huang/behaviour/data', 'The directory where the dataset files are stored.')
  ...
  with tf.Graph().as_default():
    ...
    with tf.device(deploy_config.inputs_device()):
      provider = slim.dataset_data_provider.DatasetDataProvider(
          ...
          common_queue_capacity=4 * FLAGS.batch_size,
